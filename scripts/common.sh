...
git clone -q --depth=1 https://github.com/OldCoding/luci-app-filebrowser.git package/luci-app-filebrowser
...
# 易有云菜单放进 NAS
sed -i 's|admin/services|admin/nas|g' package/linkease/luci-app-linkease/root/usr/share/luci/menu.d/*.json
